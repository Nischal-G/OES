...
include('connection.php');
	...
	if(isset($_POST['addQues']))
	{
		...
		if( ($ans1== $corr) || ($ans2== $corr) || ($ans3== $corr) || ($ans4== $corr) )  
		{
			...
			$query=mysqli_query($con,$sql);
			$_SESSION['addQuestionOk']="Data successfully saved in database.";
	...
	if(isset($_POST['addWordQues']))
	{
		...
		$query=mysqli_query($con,$sql);
		$_SESSION['addWordQuestionOk']="Data successfully saved in database.";
		header("location:" .$base_url."admin/addWordQuestion.php");
	}
